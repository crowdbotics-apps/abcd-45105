"""
Django settings for abcd_45105 project.
...
WSGI_APPLICATION = 'abcd_45105.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "abcd_45105 API",
    "DESCRIPTION": "API documentation for abcd_45105 App",
    "VERSION": "v1",
}
